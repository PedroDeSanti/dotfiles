...
local volume_slider = require("widgets.control_center.sliders.volume_slider")
local brightness_slider = require("widgets.control_center.sliders.brightness_slider")
