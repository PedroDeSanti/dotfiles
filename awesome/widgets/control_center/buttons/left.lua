...
--Custom Modules
local user = require("widgets.control_center.user_profile")
...
local buttons = {
	...
	bluetooth = create_button(container.bluetooth, "Bluetooth", false, color.magenta, "bluetoothctl power on", "bluetoothctl power off"),
